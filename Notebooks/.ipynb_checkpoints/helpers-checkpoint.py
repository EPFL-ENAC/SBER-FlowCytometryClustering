...
"""
def clusterKMeans(data,n_clusters=3, random_state=0):
...
"""
  ...
  Returns :
    An array of assignment for each sample to a cluster
"""
def clusterOPTICS(data,metric="euclidean",min_samples=22,eps=2.0,cluster_method='xi'):
